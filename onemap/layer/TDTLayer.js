...
define(["dojo/_base/declare","esri/layers/TiledMapServiceLayer","esri/layers/TileInfo","esri/geometry/Extent","esri/SpatialReference"],function(declare,TiledMapServiceLayer,TileInfo,Extent,SpatialReference){
	return declare([TiledMapServiceLayer], {
        ...
        getTileUrl: function (level, row, col) {
			if(this.tileMatrixSet=='CGCS_DOMMAP'){
				return "?TileType=CGCS_DOMMAP&TILEMATRIX=" + level + "&TILEROW=" + row + "&TILECOL=" + col + "&d="+ new Date().getTime()+"";
			}else if(this.tileMatrixSet=='CGCS_XMMAP'){
				return "?TileType=CGCS_XMMAP&TILEMATRIX=" + level + "&TILEROW=" + row + "&TILECOL=" + col + "&d="+ new Date().getTime()+"";
			}else if(this.tileMatrixSet=='CGCS_XMMAP_CVA'){
				return "?TileType=CGCS_XMMAP_CVA&TILEMATRIX=" + level + "&TILEROW=" + row + "&TILECOL=" + col + "&d="+ new Date().getTime()+"";
			}else if(this.tileMatrixSet=='CGCS_DOMMAP_CIA'){
				return "?TileType=CGCS_DOMMAP_CIA&TILEMATRIX=" + level + "&TILEROW=" + row + "&TILECOL=" + col + "&d="+ new Date().getTime()+"";
			}else{
