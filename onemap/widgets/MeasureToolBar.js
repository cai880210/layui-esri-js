define(["dojo/dom-attr","dojo/dom-construct","dojo/_base/declare","dojo/_base/Color", "dojo/string", "dojo/dom-class", "dojo/_base/kernel", 
...
function (domAttr,domConstruct,declare,Color, string,domClass, kernel, query, array, lang, _Widget, _Templated, TextSymbol,Font,Draw, on,SimpleFillSymbol,
...
//          this._baseClass = options.baseClass;
       ...
       postCreate: function () {
        ...
        startup: function () {
            ...
            //this._measureList.innerHTML = '<ul class="layui-nav">'+this._NodeList.join("") + '</ul>';
      ...
      _renderHtml:function(){
      		var ul = domConstruct.create("ul",{"class":this.ulClz},this._measureList);
      		//this.createItem(this._clearPara,ul,"after");
          dojo.forEach(this._listPara,lang.hitch(this, function (para) {
          	this.createItem(para,ul);
             // this._NodeList.push(lang.replace("\x3cli  class\x3d'{class}' type='{type}' \x3e\x3ci class\x3d'ace-icon fa {iconName} bigger-100' style\x3d'margin-right: 6px;'\x3e\x3c/i\x3e\x3cspan\x3e{alias}\x3c/span\x3e \x3c/li\x3e", para));
      ...
      createItem:function(item,srcNodeRef){
	      ...
	      var li = domConstruct.create("li",{"id":"li_measure_"+item.id,"class":item.class},srcNodeRef);
	      if(item.subData){
