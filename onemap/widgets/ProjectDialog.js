define([	"dojo/dom", 
	...
	"dojo/_base/declare","dojo/_base/lang","dojo/Evented", "dijit/Dialog","dijit/DialogUnderlay", "dojo/text!./templates/ProjectDialog.html", 			
	 ...
	 "dijit/layout/ContentPane"
		...
		function nop(){}
	 var ProjectDialog = declare([Dialog,Evented], {
		open:false,
		tabs:null,
		g:null,
		tabContainer:null,
    ...
    postCreate: function () {
        this.inherited(arguments);
        this.templateString = lang.replace(this.templateString,this.g.attributes);
